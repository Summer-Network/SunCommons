package com.summer.commons.bungee.plugin;
...
public class VulcanthBungeeException {
    ...
    public VulcanthBungeeException(ProxiedPlayer player, String throwable) {
        this.cause = throwable;
        player.sendMessage(TextComponent.fromLegacyText("§cOpa, ocorreu um erro ao executar este comando. " +
