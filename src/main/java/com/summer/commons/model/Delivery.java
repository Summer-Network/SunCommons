...
public enum Delivery {
    ...
    CASH_MVPPLUS("8", RoleEnum.PLUS, "{CASH_ICON} : 1 : nome>{color}1500 Cash : desc>&7Gratuito para você! Colete mensalmente\n&7e adquira itens épicos!\n \n{state}", 30, "cash:1500", 23),
    ...
    BOOSTER_MVPPLUS("10", RoleEnum.PLUS, "{BOOSTER_ICON} : 3 : esconder>tudo : nome>{color}3 Multiplicadores de Coins : desc>&7Gratuito para você! Colete mensalmente\n&7para conseguir ainda mais coins.\n \n &8▪ &f3 Multiplicadores Pessoal 2.0x &7(2 horas)\n \n{state}", 30, "booster:p:3", 32);
