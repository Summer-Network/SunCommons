    ...
    public void onJoin(LoginEvent e) {
        ...
        try {
            ...
            try {
                ...
                //builder = new BufferedReader(new InputStreamReader(connection.getInputStream())).readLine();

                skin = builder.toString().split("\"value\":\"")[0].split("\"")[0];
                signature = builder.toString().split("\"signature\":\"")[0].split("\"")[0];
